...
| N6 | Multi-channel distribution: email, SMS/RCS, embedded widgets, direct links | nps.today | "Benefits of Single Scale CX" (channel list); "When to Use SMS or RCS" — https://nps.today/when-to-use-sms-or-rcs/ | E | MVP: email (simulated outbox) + public/tokenized links; SMS/RCS/widgets Later | Distributions |
