...
export default async function RecruitmentPageEditor({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="space-y-4">
      ...
      <RecruitmentEditor page={data.page} questions={data.questions} availableFields={data.availableFields} availableFilterQuestions={data.availableFilterQuestions} nativeFilterQuestionsAvailable={data.nativeFilterQuestionsAvailable} />
    </div>
  );
}
